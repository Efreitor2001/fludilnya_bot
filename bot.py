...
async def rules():
    await bot.send_message(-1001745662062, '📝 *#ПРАВИЛА ФЛУДИЛЬНИ*:\n'
                                           '\n🤳 *Фото или видео экрана - бан на сутки. Только скриншоты или запись экрана.*\n'
...
async def doit():
    aioschedule.every().day.at("11:00").do(rules)
    while True:
