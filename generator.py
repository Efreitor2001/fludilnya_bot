pri = 'в, во, до, вы, пра, из, изо, пред, по, предо, па, пере, без, бес, низ, нис, раз, рас, через, черес, при,' \
      ...
      'за, а'.replace(' ', '').split(',')
bw = '6ля, 6лядь, 6лять, b3ъeб, соск, сunt, e6aль, ebal, eblan, eбaл, eбaть, eбyч, eбать, eбёт, eблантий, fuск,' \
     ' fucкеr, fucкing, xyёв, xyй, xyя, xуе, xуй, xую, zаеb, zаеbаl, zаеbаli, zаеbаt, архипиздрит, ахуел, ахуеть,' \
     ...
     ' ебуч, ебуче, ебучее, ебучий, ебучим, ебущ, ебырь, елда, елдак, елдачить, заговнять,' \
     ...
     ' какдвапальцаобоссать, конча, курва, курвятник, лярва, малафья,' \
     ...
     ' напиздел, напиздели, напиздело, напиздили, насрать, настопиздить, нахер, нахуй, нахуйник, ' \
     'не ебет, не ебёт, невротебучий, невъебенно, нехира, Нехуй, нехуйственно, ниибацо, ниипацца, ' \
     'ниипаццо, ниипет, никуя, нихера, нихуя, обдристаться, обосранец, обосрать, обосцать, обосцаться,' \
     ...
     ' похер, похерил, похерила, похерили, похеру, похуй, похуист, похуистка, похую,' \
     ...
     'сволочь, сговнять, секель, серун, серька, сестроеб, сикель, сирать, сирывать, спиздел, ' \
     ...
     'шараёбиться, шлюха, шлюхой, шлюшка, ябывает, еб, ебя, пидорасина, блядск, хуев, выеб, хуи, хуярит, ебнул,' \
     ' пиздюшк, охуе, заеби, пидр, дроч, хуенн, пезд, пизд, ебст, ебнут, еби'.replace(' ', '').split(',')
