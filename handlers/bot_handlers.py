...
def bad_words(message):
    ...
    pri = 'в, во, до, вы, пра, из, изо, пред, по, предо, па, пере, без, бес, низ, нис, раз, рас, через, черес, при,' \
          ' пре, о,  , у, под, пад, подъ, падъ, подь, падь, да'.replace(' ', '').split(',')
    bw = '6ля, 6лядь, 6лять, b3ъeб, cock, cunt, e6aль, ebal, eblan, eбaл, eбaть, eбyч, eбать, eбёт, eблантий, fuck,' \
         ...
         'шараёбиться, шлюха, шлюхой, шлюшка, ябывает, еб, ебя, пидорасина, блядск, хуев, выеб, хуи' \
        .replace(' ', '').split(',')
    ok = 'а, я, о, е, ь, ы, и, у, ю, ой, ей, ом, ем, асина, ина, ище,  , ий, ый, ца, ся, ься, ща'.replace(' ', '').split(
        ',')
    for i in pri:
        for j in bw:
            for g in ok:
